...
if __name__ == '__main__':
    ...
    parser.add_argument("--mode", default="manual", type=str) # manual pick params or grid_search
    ...
    if args.mode == "manual":
        ...
        params = []
        fs = open("save_grid.txt", "w")
        for k in np.arange(0.3, 0.5, 0.1):
            for b in np.arange(0.4, 1.0, 0.1):
                params.append([k, b])
        
        for param in params:
            bm25 = BM25Plus(documents, k1=param[0], b=param[1])
